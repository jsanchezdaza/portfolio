      ...
      <div className="container py-16 md:py-20 grid grid-cols-1 gap-6 md:grid-cols-[1fr_520px]">
        <div className="order-2 md:order-1 max-w-2xl">
          ...
          <div className="mt-6 flex gap-3">
            <a href="#projects" className="button-cta">{t('buttons.viewProjects')} <span className="badge-arrow">→</span></a>
            <a href="#contact" className="button-pill">{t('buttons.getInTouch')}</a>
          </div>
        </div>
