...
export function Header() {
  ...
  return (
    <div
      className="fixed inset-x-0 top-0 z-50 border-b border-[#17313E]/10"
    ...
    >
      <header className="container nav-retro flex h-14 items-center justify-between">
        ...
        >
          <span>
            <span style={{ color: '#415E72' }}>
              {t('profile.name').split(' ')[0]}
            </span>{' '}
            <span style={{ color: 'var(--brand2)' }}>
              {t('profile.name').split(' ').slice(1).join(' ')}
            </span>
          </span>
        </a>
        <nav className="nav-links flex items-center gap-5 text-base">
          <a href="#skills" style={{ color: '#415E72' }}>
            {t('navigation.skills')}
          </a>
          <a href="#projects" style={{ color: '#415E72' }}>
            {t('navigation.projects')}
          </a>
          <a href="#experience" style={{ color: '#415E72' }}>
            {t('navigation.experience')}
          </a>
          <a href="#contact" style={{ color: '#415E72' }}>
